          ...
          recipients: [
            {
              ...
              username: action.payload.senderUsername,
              avatar: action.payload.senderAvatar,
              profilePicture: action.payload.senderAvatar
            },
            {
              _id: action.payload.recipientId,
              name: action.payload.recipientName,
              username: action.payload.recipientUsername,
              avatar: action.payload.recipientAvatar,
              profilePicture: action.payload.recipientAvatar
            }
          ]
        }
